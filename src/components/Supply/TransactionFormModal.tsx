...
const TransactionFormModal: React.FC<TransactionRequestModalProps> = ({
  ...
  useEffect(() => {
    ...
    const loadRefs = async () => {
      try {
        ...
        const errorMessage = err instanceof Error ? err.message : "Error loading supplies";
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : "Error saving transaction";
      setError(errorMessage);
    } finally {
      setSaving(false);
    }
            ...
            <div className="mt-7">
              ...
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                ...
                <div className="col-span-2 lg:col-span-1">
                  ...
                  <select
                    className={`w-full rounded-md border p-2 text-sm dark:text-white outline-none bg-transparent border-slate-600 ${fieldErrors.supply_id ? "border-red-500" : ""
                      }`}
                ...
                <div className="col-span-2 lg:col-span-1">
                  ...
                  <select
                    className={`w-full rounded-md border p-2 text-sm dark:text-white outline-none bg-transparent border-slate-600 ${fieldErrors.region_id ? "border-red-500" : ""
                      }`}
                ...
                <div className="col-span-2 lg:col-span-1">
                  ...
                  <select
                    className={`w-full rounded-md border p-2 text-sm dark:text-white outline-none bg-transparent border-slate-600 ${fieldErrors.type_entry ? "border-red-500" : ""
                      }`}
