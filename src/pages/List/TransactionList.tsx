...
import TransactionFilterModal from "../Transactions/TransactionFilterModal";
import ConsumptionsTable, {
  type TransactionResponse,
} from "../../components/tables/SupplyList/ConsumptionsTable";
import Button from "../../components/ui/button/Button";
import { authFetchBlob } from "../../api/apiAuth"; // Import da nova função
